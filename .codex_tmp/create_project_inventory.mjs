...
const explicit = new Map([
  ...
  ["app/src/main/java/com/example/btland/activities/CreatePostActivity.java", note("Java/Activity", "Màn hình tạo bài đăng mới.", "Nhập thông tin bài, chọn/chụp ảnh thường, chọn ảnh 360 từ thư viện, lấy GPS rồi upload toàn bộ lên Firebase.", "activity_create_post.xml, Post.java, FirebaseStorageHelper.java")],
  ...
  ["app/src/main/res/layout/activity_create_post.xml", note("Resource/Layout", "Layout màn tạo bài đăng.", "Chứa form nhập bài, khu chọn ảnh, nút chọn ảnh 360 và phần preview bài.", "CreatePostActivity.java")],
